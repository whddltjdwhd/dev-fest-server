    ...
    const problemData = {
      ...
      rules: [
        ...
        },
        {
          id: 2,
          title: '이동 시간 준수',
          description: `강의 전후로 ${MASTER_CONSTRAINTS.travelTime}분의 이동 시간이 필요합니다.`,
        },
        {
          id: 3,
          title: '최소 근무 시간',
          description: `알바는 최소 ${MASTER_CONSTRAINTS.minWorkableSession}분 이상이어야 합니다.`,
        },
        {
          id: 4,
          title: '캠퍼스 활동 시간',
          description: `알바는 캠퍼스 활동 시간(${MASTER_CONSTRAINTS.campusHours.start}~${
            MASTER_CONSTRAINTS.campusHours.end
          }) 내에만 가능합니다.`,
        },
        {
          id: 5,
